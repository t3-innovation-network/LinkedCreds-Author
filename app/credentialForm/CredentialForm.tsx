...
import { Step0 } from './steps/0_login'
import { Step1 } from './steps/1_name'
import { Step2 } from './steps/2_main'
import FileUploadAndList from './steps/2_upload'
import DataComponent from './steps/3_preview'
import SuccessPage from './steps/4_finish'
...
const CredentialForm = ({ session }: CredentialFormProps) => {
  ...
  const direction = useRef<SlideProps['direction']>('left')
  ...
  return (
    <Stack direction={{ xs: 'column', md: 'row' }} spacing={{ xs: 3, md: 4 }}>
      <Box style={{ ...cardStyle, flexGrow: 1, alignSelf: 'flex-start' }}>
